...
impl ReactionType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ReactionType::Unspecified => "REACTION_TYPE_UNSPECIFIED",
            ReactionType::ThumbsUp => "THUMBS_UP",
            ReactionType::ThumbsDown => "THUMBS_DOWN",
            ReactionType::Heart => "HEART",
            ReactionType::Fire => "FIRE",
            ReactionType::ClappingHands => "CLAPPING_HANDS",
            ReactionType::Laugh => "LAUGH",
            ReactionType::OkHand => "OK_HAND",
            ReactionType::Rocket => "ROCKET",
            ReactionType::Eyes => "EYES",
            ReactionType::ThinkingFace => "THINKING_FACE",
            ReactionType::ClownFace => "CLOWN_FACE",
            ReactionType::QuestionMark => "QUESTION_MARK",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl WorkspaceSettingKey {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            WorkspaceSettingKey::Unspecified => "WORKSPACE_SETTING_KEY_UNSPECIFIED",
            WorkspaceSettingKey::Basic => "BASIC",
            WorkspaceSettingKey::General => "GENERAL",
            WorkspaceSettingKey::Storage => "STORAGE",
            WorkspaceSettingKey::MemoRelated => "MEMO_RELATED",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl ResourceStorageType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ResourceStorageType::Unspecified => "RESOURCE_STORAGE_TYPE_UNSPECIFIED",
            ResourceStorageType::Local => "LOCAL",
            ResourceStorageType::S3 => "S3",
            ResourceStorageType::External => "EXTERNAL",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
